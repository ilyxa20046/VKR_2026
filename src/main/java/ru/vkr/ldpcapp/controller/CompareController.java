    ...
    private void updateNarrative(
        ...
        String text = String.format(
                ...
                "Сравнение сценариев:%n%n" +
                        ...
                        "• канал: %s%n" +
                        "• LDPC: %s%n" +
                        "• лучший выигрыш BER: %s%n" +
                        "• лучший выигрыш BLER: %s%n" +
                        "• выигрыш BER 1e-3: %s%n" +
                        "• выигрыш BLER 1e-1: %s%n" +
